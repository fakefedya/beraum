      ...
      >
        ...
        >
          ...
          <div className="flex-1 scrollbar-thin overflow-y-auto p-6">
            {state.success ? (
              <div className="animate-in fade-in zoom-in-95 flex flex-col items-center justify-center py-10 text-center">
        ...
        <Button
          ...
          className={cn(
            "h-14 w-14 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)]",
            "bg-foreground text-background backdrop-blur-xl backdrop-saturate-150",
            "hover:bg-foreground/80 transition-all duration-300",
            isOpen &&
        ...
        >
          {isOpen ? (
            <X strokeWidth={2} className={cn("hidden, sm:block")} />
          ) : (
