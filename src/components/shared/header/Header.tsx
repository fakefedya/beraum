...
export const Header = () => {
  return (
    <header className={cn("fixed top-2 left-0 z-50 w-full px-4", "lg:top-4")}>
      <div
        className={cn(
          "bg-background/80 shadow-nav transition-width relative flex w-full max-w-full justify-between gap-1 rounded-[20px] py-1 pr-4 pl-1 backdrop-blur-xl backdrop-saturate-150",
