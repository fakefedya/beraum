...
export const Header = () => {
  return (
    <header className={cn("fixed top-4 left-0 z-50 w-full px-4", "md:px-6")}>
      <div
        className={cn(
          "bg-background/80 shadow-nav transition-width relative mx-auto flex w-fit max-w-full gap-4 rounded-xl py-1 pr-4 pl-1 backdrop-blur-xl backdrop-saturate-150",
