...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "focus-visible:ring-ring/50 flex-row items-center text-base transition-all duration-300 outline-none hover:text-black focus:text-black focus-visible:ring-[3px] focus-visible:outline-1 data-[active=true]:text-black",
        className,
      )}
      {...props}
    />
