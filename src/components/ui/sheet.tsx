  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="bg-glass ring-offset-background focus:ring-ring data-[state=open]:bg-glass stoke-black-muted absolute top-4 right-4 flex h-12 w-12 items-center justify-center rounded-full transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
