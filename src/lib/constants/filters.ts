  ...
  dishwasher: [
    ...
    },
    {
      ...
      options: [
        ...
        "Изменение программы мойки после запуска",
        "Использование средств 3-в-1",
        "Отсрочка запуска",
        "Половинная загрузка",
        "Мытье в верхнем коробе",
      ],
    },
    {
      key: "feature",
      ...
      options: [
        ...
        "Регулировка высоты корзин",
        "Съемные контейнеры для столовых приборов",
        "Полка для чашек",
        "Автоматическое открывание двери",
        "Луч на полу",
        "Разноуровневая фиксация дверцы",
      ],
    },
  ],
  microwave: [
