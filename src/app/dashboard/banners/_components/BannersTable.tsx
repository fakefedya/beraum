  ...
  return (
    <table className="w-full text-left text-sm">
      <thead className="text-muted-foreground border-b text-xs uppercase">
        <tr>
          <th className="w-32 px-4 py-4 font-medium">Превью</th>
          <th className="px-4 py-4 font-medium">Идентификатор / Место</th>
          <th className="px-4 py-4 font-medium">Конфигурация</th>
          <th className="w-24 px-4 py-4 font-medium">Сортировка</th>
